...
void FurnaceGUI::openFileDialog(FurnaceGUIFileDialogs type) {
  ...
  switch (type) {
    ...
    case GUI_FILE_OPEN_BACKUP:
      ...
      hasOpened=fileDialog->openLoad(
        _("Restore Backup"),
        {_("compatible RFurnace song formats"), "*.rfu"},
    ...
    case GUI_FILE_SAVE:
      ...
      hasOpened=fileDialog->openSave(
        _("Save File"),
        {_("compatible RFurnace song formats"), "*.rfu"},   // added the tracker module files if compatible with Ersoniq or Amiga system and the A2M format - if OPL3 or OPL2
        workingDirSong,
        dpiScale
      );
      break;
